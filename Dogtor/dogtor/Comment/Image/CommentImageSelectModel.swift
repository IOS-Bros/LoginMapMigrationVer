...
protocol CommentImageSelectModel{
    func commentImageDownloaded(items: NSMutableArray)
}


class getCommentImage{
    var delegate: CommentImageSelectModel!
    let urlPath = "http://\(myURL):8080/dogtor/comment_Image_Select.jsp"
