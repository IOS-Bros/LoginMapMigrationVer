//
//  commentSelectWriterImage.swift
//  dogtor
//
...
class CommentSelectWriterImage {
    let urlPath = "http://\(myURL):8080/dogtor/feed_writer_data_select.jsp"
    
    func requestCommentWirterImage(nickName: String, completion: @escaping(String?) -> (Void)) {
